...
Выходная информация - это информация, получаемая в результате выполнения функций информационной системы и выдаваемая на объект ее деятельности, пользователю или в другие системы. [2.2 C 7]
