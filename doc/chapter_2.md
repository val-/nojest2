...
SQL - декларативный язык запросов к базе данных. Запрос на языке SQL определяет какие данные должны быть получены или записаны в базу данных, но не накладывает никаких ограничений каким образом должны быть выполнены эти операции.

Применение алгоритмов расчёта дистанции редактирования для реализации подсказок глобального текстового поиска.
Существует множество алгоритмов поиска подстроки.
