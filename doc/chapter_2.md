...
Логическая модель базы данных необходима для понимания, как циркулируют данные в информационной системе. Эта модель строится проектировщиком, а используется разработчиком.
Существует несколько нотаций для построения логической модели данных. Наиболее распростанены нотации Питера Чена, Crows Foot, IDEF1X.
